...
from src.lenet import ResNet18
...
if __name__ == "__main__":
    ...
    ds_train = create_dataset(os.path.join(args.data_path, "E:/lenett/MNIST_Data/train"),cfg.batch_size)

    network = ResNet18(cfg.num_classes)
    #设定loss函数
